...
//		authObject, err := entity.FromString(object)
//		if err != nil {
...
//			err = objectType.ValidateRelation(entity.Entitlement(relation))
//			if err != nil {
//				return response.BadRequest(err)
//			}
//		}
...
//		authObject, _ := entity.FromString(object)
//		objectType := authObject.Type()
//		objectRef := authObject.Ref()
//		var entityID *int
//
//		if objectType != entity.TypeServer {
...
//	}
//
//	object, err := entity.FromString(objectStr)
//	if err != nil {
//		return response.SmartError(err)
//	}
//
//	err = object.Type().ValidateRelation(entity.Entitlement(relation))
//	if err != nil {
//		return response.BadRequest(err)
//	}
//
...
//}
//
//func manageGroupEntitlement(ctx context.Context, tx *db.ClusterTx, groupName string, object string, relation string, revoke bool) error {
//	group, err := cluster.GetGroup(ctx, tx.Tx(), groupName)
//	if err != nil {
//		return err
//	}
