...
var networkACLsCmd = APIEndpoint{
	...
	Post: APIEndpointAction{Handler: networkACLsPost, AccessHandler: allowProjectPermissionWithFeatureFlag("features.networks", auth.EntitlementCanCreateNetworkACLs)},
}
