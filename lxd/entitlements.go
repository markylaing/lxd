...
//	entitlementMap := make(map[string]map[entity.Entitlement][]string)
...
//		if !ok {
//			entitlementMap[object] = map[entity.Entitlement][]string{}
...
//		}
//	} else {
//		if len(entity.Type(objectType).Relations()) == 0 {
//			return response.SmartError(fmt.Errorf("Object type %q has no relations", objectType))
//		}
//	}
//
//	entitlements := make(map[string]map[entity.Entitlement][]string)
//err = d.db.Cluster.Transaction(r.Context(), func (ctx context.Context, tx *db.ClusterTx) error {
//	var q string
//	var args []any
//	if isObject {
...
//		var groupName string
//		var object entity.
//		var relation entity.Entitlement
//		err = rows.Scan(&groupName, &object, &relation)
//		if err != nil {
//			return err
//		}
...
//		if !ok {
//			entitlements[object] = map[entity.Entitlement][]string{}
//			for _, relation := range object.Type().Relations() {
