...
var imageAliasesCmd = APIEndpoint{
	...
	Post: APIEndpointAction{Handler: imageAliasesPost, AccessHandler: allowProjectPermissionWithFeatureFlag("features.images", auth.EntitlementCanCreateImageAliases)},
}
