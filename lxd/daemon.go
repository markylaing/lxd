...
func allowProjectResourceList(allowAllProjectsForRestrictedTLSClients bool) func(d *Daemon, r *http.Request) response.Response {
	return func(d *Daemon, r *http.Request) response.Response {
		requestor, err := request.GetRequestor(r.Context())
		if err != nil {
			return response.SmartError(err)
		...
		if allProjects {
			if allowAllProjectsForRestrictedTLSClients {
				return response.EmptySyncResponse
			}
