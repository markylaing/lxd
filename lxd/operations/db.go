...
func finalizeUnfinishedDBOperations(ctx context.Context, tx *db.ClusterTx, operationsToReconstruct map[string]cluster.Operation, durableOperationUUIDsToRestart map[string]struct{}) error {
	const (
