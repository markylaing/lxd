...
//}
//
//func parseEntitlement(args []string, conf *config.Config, remoteName string, target string) (string, entity.Entitlement, error) {
...
//	}
//
//	if entity.Type(args[1]) == entity.TypeServer {
//		if len(args) != 3 {
//			return "", "", fmt.Errorf("Expected three arguments: `lxc group grant [<remote>:]<group> server <relation>`")
//		}
//
//		relation := entity.Entitlement(args[2])
//		err := entity.TypeServer.ValidateRelation(relation)
//		if err != nil {
//			return "", "", err
//		}
//
//		return entity.Server(), relation, nil
//	}
//
//	object, err := entity.FromString(args[1])
//	if err == nil {
//		if len(args) != 3 {
...
//	objectType := args[1]
//	objectName := args[2]
//	relation := entity.Entitlement(args[3])
//
...
//	}
//
//	switch entity.Type(objectType) {
//	case entity.TypeGroup:
//		object = entity.Group(objectName)
//	case entity.TypeCertificate:
//		object = entity.Certificate(objectName)
//	case entity.TypeStoragePool:
//		object = entity.StoragePool(objectName)
//	case entity.TypeProject:
//		object = entity.Project(objectName)
//	case entity.TypeImage:
//		object = entity.Image(projectName, objectName)
//	case entity.TypeImageAlias:
//		object = entity.ImageAlias(projectName, objectName)
//	case entity.TypeInstance:
//		object = entity.Instance(projectName, objectName)
//	case entity.TypeNetwork:
//		object = entity.Network(projectName, objectName)
//	case entity.TypeNetworkACL:
//		object = entity.NetworkACL(projectName, objectName)
//	case entity.TypeNetworkZone:
//		object = entity.NetworkZone(projectName, objectName)
//	case entity.TypeProfile:
//		object = entity.Profile(projectName, objectName)
...
//		}
//
//		object = entity.StorageBucket(projectName, poolName, objectName, target)
...
//		}
//
//		object = entity.StorageVolume(projectName, poolName, volumeType, objectName, target)
//	default:
